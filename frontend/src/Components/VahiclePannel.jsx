...
const VahiclePannel = ({ setVehiclePannel,setConfirmRide}) => {
  ...
  return (
    <div className="">
      <h5 className="p-1 text-center w-[93%] top-0">
      ...
      <div className="flex border-2 active:border-black  mb-2 rounded-xl w-full p-3  items-center justify-between " onClick={handleSelectVehicle}>
        <img
          className="h-10"
      ...
      <div className="flex border-2 active:border-black mb-2 rounded-xl w-full p-3  items-center justify-between " onClick={handleSelectVehicle}>
        ...
        <h2 className="text-lg font-semibold">₹77</h2>
      </div>
    </div>
  );
};

export default VahiclePannel;
